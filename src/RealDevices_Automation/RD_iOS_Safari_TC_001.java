...
public class RD_iOS_Safari_TC_001 {
	...
	public static void main(String[] args) throws InterruptedException, MalformedURLException {
		...
		capabilities.setCapability("deviceName","MdmIphone");		
		capabilities.setCapability("udid","ec0eedd25d043834097e1e403c3cbc99e14634b6");	
		capabilities.setCapability("platformVersion","7.1.1");	
		File app = new File("/Users/test/Desktop/Softwares/mobile-apps/SafariLauncher.app");
		capabilities.setCapability("app","/Users/test/Desktop/Softwares/mobile-apps/SafariLauncher.app");
		capabilities.setCapability("bundleId", "com.accenture.mobility.appfactory.dev1.SafariLauncher");
